...
class BlockOverlayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Show over lock screen — use the modern Activity API on API 27+ (Pixel 8/9),
        // and fall back to window flags on older devices.
        ...
        // Route back-press to home instead of back to the blocked app.
        // onBackPressedDispatcher replaces the deprecated onBackPressed() on API 33+.

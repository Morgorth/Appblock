...
public final class ItemProfileBinding implements ViewBinding {
  ...
  private ItemProfileBinding(@NonNull CardView rootView, @NonNull ImageButton btnDelete,
      @NonNull SwitchMaterial switchEnabled, @NonNull TextView tvProfileName) {
  ...
  public static ItemProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProfileBinding((CardView) rootView, btnDelete, switchEnabled, tvProfileName);
    }
